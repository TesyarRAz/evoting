...
<div id="wrapper">
	...
	<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
		...
		<!-- Nav Item - Dashboard -->
		<li class="nav-item <?= $request->uri->getPath() == '/' ? 'active' : '' ?>">
		...
		<!-- Nav Item - Charts -->
		<li class="nav-item <?= $request->uri->getPath() == 'admin/kandidat/index' ? 'active' : '' ?>">
			<a class="nav-link" href="<?= site_url('admin/kandidat/index') ?>">
				<i class="fas fa-fw fa-user"></i>
				<span>Kandidat</span>
			</a>
		</li>
		...
		<!-- Nav Item - Charts -->
		<li class="nav-item <?= $request->uri->getPath() == 'admin/laporan/chart' ? 'active' : '' ?>">
			<a class="nav-link" href="<?= site_url('admin/laporan/chart') ?>">
